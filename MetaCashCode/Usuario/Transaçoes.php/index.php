    ...
    <div class="flex">
        ...
        <aside class="flex flex-col min-h-screen w-64 bg-[#0f172a] text-white p-4">
            ...
            <nav class="flex-1 space-y-3">
                ...
                <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-[#1e3a5f] text-gray-200 hover:bg-slate-700 transition">
                    <i class="fas fa-file-download"></i>
                    <span class="font-medium text-sm">Baixar Relatório</span>
                </a>
            </nav>

            <div class="mt-auto pt-6 border-t border-slate-800">
                <div class="flex items-center gap-3 p-3 bg-[#1e3a5f] rounded-xl mb-4">
                    <div class="w-10 h-10 rounded-full bg-[#2dd4bf] flex items-center justify-center text-[#0f172a] font-bold">
                        E
                    </div>
                    <div class="overflow-hidden">
                        <p class="text-sm font-semibold truncate">Empresa LTDA</p>
